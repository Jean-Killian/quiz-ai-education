            ...
            <div class="theme-bg-panel overflow-hidden shadow-2xl rounded border theme-border theme-glow">
                <div class="p-6">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4 border-b theme-border pb-6">
                        ...
                        <a href="<?php echo e(route('quizzes.generate')); ?>" class="theme-bg-deep border-2 theme-border-primary theme-primary font-black py-2 px-6 rounded text-xs uppercase tracking-widest transition-all shadow-[0_0_15px_var(--primary-glow)] flex items-center gap-2 group hover:theme-bg-panel">
                            ...
                            <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="group theme-bg-deep border theme-border p-5 rounded hover:theme-border-primary transition-all flex flex-col md:flex-row justify-between items-center gap-4 relative overflow-hidden">
                                    ...
                                    <div class="relative z-10 flex items-center gap-4 w-full">
                                        ...
                                        <div>
                                            <div class="font-bold text-white text-lg tracking-tight uppercase group-hover:theme-primary transition-colors"><?php echo e($quiz->title); ?></div>
                                    ...
                                    <div class="relative z-10 flex items-center gap-6 w-full md:w-auto justify-between md:justify-end border-t md:border-t-0 theme-border pt-4 md:pt-0">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('quizzes.show', $quiz->id)); ?>" class="px-5 py-2 border theme-border text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] rounded-sm hover:theme-bg-panel hover:theme-border-primary hover:theme-primary transition-all">
                                            > Lancer_Hack
                                        </a>
                                    </div>
                                </div>
