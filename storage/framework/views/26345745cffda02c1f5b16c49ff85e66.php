                ...
                <div class="p-6 text-gray-300">
                    ...
                    <form action="<?php echo e(route('quizzes.generate.post')); ?>" method="POST" onsubmit="showLoader()">
                        ...
                        <div class="flex items-center justify-between border-t border-gray-700 pt-5 mt-2">
                            <a href="<?php echo e(route('quizzes.index')); ?>" class="text-sm text-gray-500 hover:text-red-400 font-mono">[ ABORT ]</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\mat95\OneDrive\Bureau\ProjetEcole\quiz-ai-education\resources\views/quizzes/generate.blade.php ENDPATH**/ ?>