    ...
    <div class="py-12 theme-bg-deep min-h-screen">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="theme-bg-panel border-2 theme-border rounded-lg overflow-hidden theme-glow">
                    ...
                    <div class="flex-grow text-center md:text-left">
                        ...
                        <div class="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
                            <div class="px-4 py-2 theme-bg-deep border theme-border rounded shadow-inner">
                                ...
                                <span class="theme-primary font-bold text-xl font-mono"><?php echo e(number_format(auth()->user()->global_score)); ?> XP</span>
                            </div>
                            <div class="px-4 py-2 theme-bg-deep border theme-border rounded shadow-inner">
                                ...
                                <span class="text-orange-500 font-bold text-xl font-mono uppercase">
                                    <?php echo e(auth()->user()->current_streak); ?> 🔥
                                </span>
                            </div>
                            <div class="px-4 py-2 theme-bg-deep border theme-border rounded shadow-inner">
                ...
                <!-- Badges Showcase -->
                <?php if(auth()->user()->badges->count() > 0): ?>
                <div class="bg-black/20 border-t border-slate-700 p-4">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="flex items-center gap-2 bg-slate-800/50 border theme-border p-2 rounded group relative hover:theme-border-primary transition-all cursor-help" title="<?php echo e($badge->description); ?>">
                            <div class="theme-primary">
                                <?php if($badge->icon === 'zap'): ?> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M13 10V3L4 14h7v7l9-11h-7z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                ...
                                <?php elseif($badge->icon === 'ghost'): ?> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 11V9a2 2 0 00-2-2m-1 7l3 3m-3-3l-3-3m3 3l3-3m-3 3l-3 3M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                <?php elseif($badge->icon === 'flame'): ?> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.99 7.99 0 0120 13a7.99 7.99 0 01-2.343 5.657z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                            ...
                            <span class="text-[10px] uppercase font-black tracking-widest text-white"><?php echo e($badge->name); ?></span>
                        </div>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <select id="theme" name="theme" 
                                    ...
                                    <option value="matrix" <?php echo e(auth()->user()->theme === 'matrix' ? 'selected' : ''); ?>>MATRIX (Classic Green)</option>
                                    <option value="cyberpunk" <?php echo e(auth()->user()->theme === 'cyberpunk' ? 'selected' : ''); ?>>CYBERPUNK (Neon Fuchsia)</option>
                                    <option value="dark_web" <?php echo e(auth()->user()->theme === 'dark_web' ? 'selected' : ''); ?>>DARK WEB (Cruel Red)</option>
                                    <option value="bios" <?php echo e(auth()->user()->theme === 'bios' ? 'selected' : ''); ?>>BIOS (Legacy Blue)</option>
                                </select>
                                <?php if (isset($component)) { $__componentOriginalcfef9ae9d181bd9f9c23f131244452e1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalcfef9ae9d181bd9f9c23f131244452e1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.forms.input-error','data' => ['class' => 'mt-2','messages' => $errors->get('theme')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('forms.input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-2','messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('theme'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalcfef9ae9d181bd9f9c23f131244452e1)): ?>
<?php $attributes = $__attributesOriginalcfef9ae9d181bd9f9c23f131244452e1; ?>
