            ...
            <div class="bg-slate-800 overflow-hidden shadow-2xl rounded border border-slate-700">
                <div class="p-6">
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4 border-b border-slate-700 pb-6">
                        ...
                        <a href="{{ route('quizzes.generate') }}" class="bg-green-600 hover:bg-green-500 text-black font-black py-2 px-6 rounded text-xs uppercase tracking-widest transition-all shadow-[0_0_15px_rgba(34,197,94,0.3)] flex items-center gap-2 group">
                            ...
                            @foreach($quizzes as $quiz)
                                <div class="group bg-slate-900/50 border border-slate-700 p-5 rounded hover:border-green-500/50 transition-all flex flex-col md:flex-row justify-between items-center gap-4 relative overflow-hidden">
                                    ...
                                    <div class="relative z-10 flex items-center gap-4 w-full">
                                        ...
                                        <div>
                                            <div class="font-bold text-white text-lg tracking-tight uppercase group-hover:text-green-400 transition-colors">{{ $quiz->title }}</div>
                                    ...
                                    <div class="relative z-10 flex items-center gap-6 w-full md:w-auto justify-between md:justify-end border-t md:border-t-0 border-slate-800 pt-4 md:pt-0">
                                        ...
                                        @endif
                                        <a href="{{ route('quizzes.show', $quiz->id) }}" class="px-5 py-2 border border-slate-600 text-slate-400 text-[10px] font-black uppercase tracking-[0.2em] rounded-sm hover:bg-green-600 hover:border-green-600 hover:text-black transition-all">
                                            > Lancer_Hack
                                        </a>
                                    </div>
                                </div>
