        ...
        <div class="relative z-10 flex flex-col min-h-screen p-6 sm:p-12">
            ...
            <header class="flex justify-between items-center mb-16 border-b border-slate-800 pb-6">
                ...
                <nav class="flex gap-4 font-mono text-sm">
                    @auth
                        <a href="{{ url('/dashboard') }}" class="text-slate-300 hover:text-hacker-400 transition flex items-center gap-2">
                            <span>>_ DASHBOARD</span>
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="text-slate-300 hover:text-hacker-400 transition px-4 py-2 border border-transparent">Login</a>
                        <a href="{{ route('register') }}" class="text-hacker-400 hover:text-black hover:bg-hacker-400 transition border border-hacker-400 px-4 py-2 rounded-sm shadow-[0_0_10px_rgba(74,222,128,0.2)]">Init_System()</a>
                    @endauth
                </nav>
            </header>
            ...
            <main class="flex-grow flex flex-col lg:flex-row items-center justify-between gap-12 mt-8">
                ...
                <div class="w-full lg:w-1/2 flex flex-col items-start gap-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mt-4 w-full">
                        <a href="{{ route('register') }}" class="inline-flex justify-center items-center gap-2 bg-hacker-600 hover:bg-hacker-500 text-white font-mono font-bold uppercase tracking-widest px-8 py-4 rounded-sm transition shadow-[0_0_20px_rgba(22,163,74,0.4)] glitch-hover">
                            > Démarrer la Traque
                        </a>
